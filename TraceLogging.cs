...
namespace WindowsFormsNetFx
{
    ...
    {
        #region プロパティ
        public static string BaseProgName { get; set; }    // プログラム名
        public static string TerminalName { get; set; }    // 端末名 (RDPの場合は接続元の端末名)取得
        ...
        {
            // 基本情報
            BaseProgName = Process.GetCurrentProcess().ProcessName;
            TerminalName = GetTerminalName();

            // トレースログ
            LogObj = new TraceLogObject(BaseProgName, TerminalName);
        }
        /// <summary>
        /// 後処理 - インスタンス開放
        /// </summary>
        ...
        public class TraceLogObject
        {
            ...
            /// 生成/消滅
            /// </summary>
            public TraceLogObject(string progname, string terminal)
            {
